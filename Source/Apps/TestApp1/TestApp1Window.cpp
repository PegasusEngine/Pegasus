...
//    Pegasus::Alloc::IAllocator * timelineAllocator = timeline->GetAllocator();
//
//    //! \todo Should it be part of the app instead? Might be duplicated when having multiple windows
//    TestApp1::PsyBeadsBlock * psyBeadBlock = PG_NEW(timelineAllocator, -1, "PsyBeadsBlock", Pegasus::Alloc::PG_MEM_PERM) TestApp1::PsyBeadsBlock(timelineAllocator, GetWindowContext());
//    psyBeadBlock->SetPosition(3.0f);
//    psyBeadBlock->SetLength(2.5f);
