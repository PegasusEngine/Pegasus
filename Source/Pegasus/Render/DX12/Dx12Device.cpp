...
GpuStateRef Dx12Device::InternalCreateGpuState(const GpuStateConfig& config)
{
    GpuStateRef stateRef = D12_NEW(mAllocator, "Dx12GpuState")  Dx12GpuState(config, this);
    return stateRef;
}
